...
class EpicTest {
    ...
    void deleteEpic() {
        ...
        assertThrows(NotFoundException.class, () -> taskManager.getEpicByID(epic.getId()),
                "Удаление эпиков работает некорректно в Менеджере задач.");
    }
    ...
    void createAllSubtasksNEW() {
        ...
        Subtask subtask2 = new Subtask("Subtask2", "Subtask1 Description", epic.getId());
        Subtask subtask3 = new Subtask("Subtask3", "Subtask1 Description", epic.getId());
        Subtask subtask4 = new Subtask("Subtask4", "Subtask1 Description", epic.getId());
    ...
    void shouldChangeStatusAfterSubtasksUpdate() {
        ...
        taskManager.addSubtask(subtask3);
        taskManager.addSubtask(subtask4);
        taskManager.updateSubtask(subtask1.getId(), new Subtask(subtask1.getName(), subtask1.getDescription(),
                epic.getId(), "IN_PROGRESS"));
